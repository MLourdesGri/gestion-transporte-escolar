      ...
      <template v-else>
        <div class="ion-padding">
          ...
          <ion-card>
            ...
            <ion-card-content>
              <p>Precio mensual: ${{ prices[0].monthly_price }} pesos</p>
              <p>Precio semanal: ${{ prices[0].daily_price }} pesos</p>
            </ion-card-content>
          </ion-card>
      ...
      <ion-modal ref="modalRef" :is-open="isModalOpen" @did-dismiss="closeModal">
        ...
        <ion-content class="ion-padding">
          <div class="input-with-currency">
            ...
            <span class="currency-label">pesos</span>
          </div>
...
/* New styles for input with currency label */
.input-with-currency {
  display: flex;
  align-items: end; 
}
